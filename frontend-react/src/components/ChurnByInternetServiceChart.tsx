...
const ChurnByInternetServiceChart: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setData(response.data.byInternetService || []);
      } catch (err: any) {
  ...
  return (
    <div className="card">
      <h2 className="mb-4 text-lg font-semibold text-gray-900">Churn Rate by Internet Service</h2>
...
export default ChurnByInternetServiceChart;
